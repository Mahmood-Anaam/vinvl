...
from vinvl.maskrcnn_benchmark.modeling.detector.generalized_rcnn import GeneralizedRCNN
from .relation_head.relation_head import build_roi_relation_head
from vinvl.maskrcnn_benchmark.modeling.backbone import build_backbone
