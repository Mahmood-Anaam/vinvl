...
from vinvl.maskrcnn_benchmark.modeling.roi_heads.mask_head.inference import Masker
...
from vinvl.maskrcnn_benchmark.data.datasets.evaluation.cityscapes import eval_instances
